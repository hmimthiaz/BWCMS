...
class TwigService extends BaseService implements \Twig_Extension_InitRuntimeInterface, \Twig_ExtensionInterface, \Twig_Extension_GlobalsInterface
{
    ...
    {
        return array(
            new \Twig_SimpleFunction('skin', array($this, 'getSkin'), array('is_safe' => array('html'))),
            new \Twig_SimpleFunction('skinAsset', array($this, 'getSkinAsset'), array('is_safe' => array('html'))),
            new \Twig_SimpleFunction('setSkinAssetPrefix', array($this, 'setSkinAssetPrefix'), array('is_safe' => array('html'))),
            new \Twig_SimpleFunction('link', array($this, 'getContentLink')),
            new \Twig_SimpleFunction('download', array($this, 'getContentDownloadLink')),
            new \Twig_SimpleFunction('menu', array($this, 'getContentMenu'), array('is_safe' => array('html'))),
            new \Twig_SimpleFunction('widget', array($this, 'getContentWidget'), array('is_safe' => array('html'))),
            ...
            new \Twig_SimpleFunction('loc', array($this, 'getLocale'), array('is_safe' => array('html'))),
            new \Twig_SimpleFunction('emailLink', array($this, 'getEmailLink'), array('is_safe' => array('html'))),
            new \Twig_SimpleFunction('navLink', array($this, 'getNavLink')),
            new \Twig_SimpleFunction('lang', array($this, 'getLanguages'), array('is_safe' => array('html'))),
            new \Twig_SimpleFunction('exit', array($this, 'doExit'), array('is_safe' => array('html'))),
        );
    }
